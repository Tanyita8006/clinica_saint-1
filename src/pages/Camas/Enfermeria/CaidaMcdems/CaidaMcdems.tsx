...
import DatosGenerales from "../../../Facturacion/Anticipos/DatosGenerales";
import DatosPaciente from "../Kardex/DatosPaciente";
import Anticipo from "../../../Facturacion/Caja/FormasPago/Anticipo";
...
export default function CaidaMcdems() {
